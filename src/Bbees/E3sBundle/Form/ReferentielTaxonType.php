...
class ReferentielTaxonType extends AbstractType
{
    ...
    {
        $builder->add('taxname')->add('rank')->add('subclass')->add('ordre')->add('family')->add('genus')->add('species')->add('subspecies')->add('validity')->add('codeTaxon')->add('clade')->add('taxnameRef')
                ->add('commentaireRef')
